 ...
 */
@WebServlet("/ExcluirAeroporto")
public class ExcluirAeroporto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcluirAeroporto() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String view = "views/aeroporto/excluir.jsp";
    	try{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(id > 0){
    		Aeroporto aeroporto = new Aeroporto();
    		boolean resultado = aeroporto.remover(id);
			 if(!resultado){
				 request.setAttribute("erroMsg", "remover_erro");
				 request.setAttribute("id",id);
				 view = "./ExcluirAeroporto";
			 }else{
